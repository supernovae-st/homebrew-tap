...
class Spn < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/supernovae-st/supernovae-cli/releases/download/v0.9.0/spn-x86_64-apple-darwin.tar.gz"
      sha256 "d37f3ebde6bdebde0cdf450f14b140dd1791b5a1c0820e14675dc1ce0179d771"
    end
    on_intel do
