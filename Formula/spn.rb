...
class Spn < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/supernovae-st/supernovae-cli/releases/download/v0.8.1/spn-x86_64-apple-darwin.tar.gz"
      sha256 "e2c6aa8179d15403a452d991cff646e725dccbf94671fb30bb7c16808e9e62b3"
    end
    on_intel do
