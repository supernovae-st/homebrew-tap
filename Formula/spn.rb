...
class Spn < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/supernovae-st/supernovae-cli/releases/download/v0.12.0/spn-aarch64-apple-darwin.tar.gz"
      sha256 "feb8ebc2b24552d14c24c27ef5ff19ba2f0f8f05fa15b86b959c9eaeb589ff7d"
    end
    on_intel do
